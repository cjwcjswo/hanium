	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12" id="noticeBoard">
				<h4>
					<font size="14px" color="gray"> 공지게시판 </font>
				</h4>
				<br>
		...
		<div style="text-align: center">
			<ul class="pagination">
				<c:if test="${pm.previous}">
					<li><a
						href="${pageContext.request.contextPath}/notice/list?page=${pm.lastPage - 10}"><span
				...
				<c:forEach begin="${pm.startPage}" end="${pm.lastPage}"
					...
					<c:if test="${pm.currentPage == state.count}">
						<li class="active"><a
							href='${pageContext.request.contextPath}/notice/list?page=${pm.startPage + state.count-1}'>${pm.startPage + state.count-1}</a>
						</li>
					</c:if>
					<c:if test="${pm.currentPage != state.count}">
						<li><a
				...
				<c:if test="${pm.next}">
					<li><a
						href="${pageContext.request.contextPath}/notice/list?page=${pm.lastPage + 1}"><span
