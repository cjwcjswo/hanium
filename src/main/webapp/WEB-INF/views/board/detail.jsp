...
<body>
	<br>
	<br>
	<form name="f" method="post" action="${pageContext.request.contextPath}/board/insertReply">
				...
				<table class="table table-striped table-bordered table-hover" id="replyTable">
					...
					<c:forEach items="${replyList}" var="reply">
						<tr>
							...
							<th><a href="${pageContext.request.contextPath}/board/reply/delete/${reply.userId}/${board.boardNum}/${reply.replyNum}"
